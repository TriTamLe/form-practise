...
import {CustomFormItem, MemoizedUniversitySelectFormItem,} from '@/features/sclub-member/components'
import {
    DATE_FORMAT,
    GENDER_OPTIONS,
    LABELS,
...
import {UploadImageFormField} from "@/features/upload-image";
...
export const PersonalInformationForm = () => {
    ...
    return (<Flex vertical align='center' gap={20}>
        <Typography.Title level={2}>Personal Information</Typography.Title>
        <div className='w-full max-w-[70%] px-20'>
            <UploadImageFormField name={SCLUB_MEMBER_KEYS.PROFILE_PICTURE}
                                  fileUrlFieldName={SCLUB_MEMBER_KEYS.FILE}
                                  imageUrlFieldName={SCLUB_MEMBER_KEYS.IMAGE_URL}
                                  label={LABELS.PROFILE_PICTURE}
                                  required
            />
            <CustomFormItem name={SCLUB_MEMBER_KEYS.GENDER} label={LABELS.GENDER} required>
                <Radio.Group options={GENDER_OPTIONS} optionType="default"
                             size='large'/>
            </CustomFormItem>
            <CustomFormItem
            ...
            <MemoizedUniversitySelectFormItem
                ...
                autoCompleteProps={{
                    size: 'large', placeholder: PLACEHOLDERS.UNIVERSITY,
                }}
            />
            <CustomFormItem
