...
export type TSClubMember = {
    [SCLUB_MEMBER_FORM_NAMES.PROFILE_PICTURE]: {
        [SCLUB_MEMBER_FORM_NAMES.FILE]: Blob, [SCLUB_MEMBER_FORM_NAMES.IMAGE_URL]: string
    }
...
export type TSClubMemberDTO = {
    [SCLUB_MEMBER_FORM_NAMES.PROFILE_PICTURE]: string
    [SCLUB_MEMBER_FORM_NAMES.EMAIL]: string
    [SCLUB_MEMBER_FORM_NAMES.PASSWORD]: string
    [SCLUB_MEMBER_FORM_NAMES.FULL_NAME]: string
    [SCLUB_MEMBER_FORM_NAMES.PHONE]: string
    [SCLUB_MEMBER_FORM_NAMES.BIRTHDAY]: string
    [SCLUB_MEMBER_FORM_NAMES.ADDRESS]: string
    [SCLUB_MEMBER_FORM_NAMES.UNIVERSITY]?: string
    [SCLUB_MEMBER_FORM_NAMES.MAJOR]?: string
    [SCLUB_MEMBER_FORM_NAMES.MEMBER_TYPE]: string
    [SCLUB_MEMBER_FORM_NAMES.HOUSE]: string
    [SCLUB_MEMBER_FORM_NAMES.PARTICIPANT_TERM]: string
    [SCLUB_MEMBER_FORM_NAMES.HASROLE]?: boolean
    [SCLUB_MEMBER_FORM_NAMES.ROLES]?: {
        [SCLUB_MEMBER_FORM_NAMES.TERM]: string
        [SCLUB_MEMBER_FORM_NAMES.ROLE]: string
    }[]
}
